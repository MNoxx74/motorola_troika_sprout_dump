...
# Assert
TARGET_OTA_ASSERT_DEVICE := troika_sprout
...
TARGET_KERNEL_SOURCE := kernel/motorola/troika_sprout
TARGET_KERNEL_CONFIG := troika_sprout_defconfig

# Platform
TARGET_BOARD_PLATFORM := erd9610
